...
namespace Enderlook.Unity.Toolset.Checking.PostCompiling.Attributes
{
    ...
    public sealed class ExecuteOnEachFieldOfEachTypeWhenCheckAttribute : BaseExecuteWhenCheckAttribute
    {
        ...
        public ExecuteOnEachFieldOfEachTypeWhenCheckAttribute(FieldSerialization fieldFlags = FieldSerialization.EitherSerializableOrNotByUnity, int order = 0) : base(order) => fieldFilter = fieldFlags;
        ...
        /// </summary>
        /// <param name="order">In which order will this method be executed.</param>
        public ExecuteOnEachFieldOfEachTypeWhenCheckAttribute(int order = 0) : base(order) => fieldFilter = FieldSerialization.EitherSerializableOrNotByUnity;
    }
}